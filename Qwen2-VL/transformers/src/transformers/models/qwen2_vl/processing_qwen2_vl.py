    ...
    def __call__(
        ...
        **kwargs,
        ...
        if images is not None:
            image_inputs = self.image_processor(images=images, videos=None, return_tensors=return_tensors, **kwargs)
        ...
        if videos is not None:
            videos_inputs = self.image_processor(images=None, videos=videos, return_tensors=return_tensors, **kwargs)
        ...
        if image_grid_thw is not None:
            ...
            index = 0
            for i in range(len(text)): # �˴�iָ��i���ı�����batch_size
